...
public class ArrayAdapterDetailAdmin extends ArrayAdapter<User> {

    private Context mContext;
    private List<User> moviesList = new ArrayList<>();

    public ArrayAdapterDetailAdmin(@NonNull Context context, @SuppressLint("SupportAnnotationUsage") @LayoutRes ArrayList<User> list) {
